...
DATABASES = {
    'default': {
        ...
        'NAME': 'haystack_demo',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'rdbt%l(lxmr_3nahe+g^r7eg4yn$r1s=09c4st95+exn=bo055'
...
HAYSTACK_SOLR_URL = 'http://localhost:8080/demo'
